...
export default function Page() {
  ...
  const [globeResult, setGlobeResult] = useState<GlobeResult | undefined>(
    undefined
  );
  ...
  if (typeof window !== "undefined") {
    (
      window as Window &
        typeof globalThis & {
          handlePlaceSearchResult?: (result: GlobeResult) => void;
        }
    ).handlePlaceSearchResult = handlePlaceSearchResult;
  }
        ...
        <TamboMcpProvider mcpServers={mcpServers}>
          ...
          <div className="h-14 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md">
            <div className="flex items-center space-x-2">
              <h3
                className="text-3xl font-bold z-30 text-gray-300 dark:text-white"
                style={{ textShadow: "0 2px 16px rgba(59,130,246,0.12)" }}
              >
                🐙 Tambo OS
              </h3>
            </div>
                    ...
                    tracks={[
                      {
                        ...
                        albumCover:
                          "https://static.vecteezy.com/system/resources/previews/021/646/276/non_2x/vinyl-record-with-album-cover-on-package-music-retro-vintage-concept-flat-styleillustration-vector.jpg",
                      },
                    ]}
                    currentIndex={0}
                    isPlaying={false}
